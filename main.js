...
while (condition) {
    ...
    if (!appendTask.appendedTask) {
        ...
        console.log(chalk.green(`"${chalk.rgb(56, 78, 90)(appendTask.appendedTask)}" Your task has been successfully added to the todo list.\n`));
        ...
        if (condition = appemdMoreTask.addMore) {
            ...
            if (condition = ques.confirm) {
                ...
                if (ans.moreOptions === "update list") {
                    ...
                    let newtodo = toDoList.filter(val => val !== updateTodo.update);
